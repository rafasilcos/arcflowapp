...
import orcamentosInteligentesRoutes from './routes/orcamentos-inteligentes';
import configuracoesOrcamentoRoutes from './routes/configuracoes-orcamento';
...
export class ArcFlowServer {
  ...
  private setupRoutes(): void {
    ...
    this.app.use('/api/orcamentos', orcamentosRoutes);
    this.app.use('/api/orcamentos-inteligentes', orcamentosInteligentesRoutes);
    this.app.use('/api/configuracoes-orcamento', configuracoesOrcamentoRoutes);
    this.app.use('/api/test-data', testDataRoutes);
