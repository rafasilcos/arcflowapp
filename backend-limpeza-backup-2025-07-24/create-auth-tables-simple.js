...
async function createAuthTables() {
  try {
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS "idx_users_escritorio" ON "users"("escritorio_id");`);
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS "idx_projetos_escritorio" ON "projetos"("escritorio_id");`);
    ...
    await client.query(`
      ...
      VALUES ('user_admin_teste', 'admin@arcflow.com', '$2b$10$rOzJKjQcjQcjQcjQcjQcjOzJKjQcjQcjQcjQcjQcjOzJKjQcjQcjQ', 'Admin Teste', 'OWNER', 'escritorio_teste', true)
      ON CONFLICT ("id") DO NOTHING;
    `);
    ...
    console.log('   📋 Plano: ArcFlow Profissional');
    console.log('');
