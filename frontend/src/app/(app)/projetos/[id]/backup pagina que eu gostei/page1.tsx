...
export default function DashboardProdutividadeV7({ params }: DashboardProps) {
  ...
  // Função REAL para calcular próximas tarefas baseada em dados reais
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <AnimatePresence>
        ...
        <Card className="w-full">
          ...
          <CardContent>
            {/* Layout principal com alinhamento dinâmico */}
            <div className="flex gap-6 items-start">
              
              {/* Sidebar de contexto - largura fixa */}
              ...
              {/* Chat principal - ocupa o resto do espaço e se alinha automaticamente */}
              <div className="flex-1">
                <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl border border-slate-200 overflow-hidden">
                  {/* Header do chat */}
                  <div className="px-4 py-3 bg-white/80 backdrop-blur border-b border-slate-200">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                  ...
                  {/* Mensagens - altura fixa para alinhamento */}
                  <div className="p-4 space-y-3 overflow-y-auto h-64">
                  ...
                  <div className="p-4 bg-white/80 backdrop-blur border-t border-slate-200">
                    <div className="flex gap-2">
                      <Input 
                        ...
                        className="flex-1 h-9 border-slate-300 bg-white/80 placeholder:text-slate-400" 
                      />
                      <Button className="h-9 px-4 bg-blue-500 hover:bg-blue-600">
